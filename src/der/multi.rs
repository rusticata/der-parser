use crate::ber::{BerObjectHeader, BerSize};
use crate::der::*;
use crate::error::*;
...
where
    F: Fn(&'a [u8]) -> BerResult,
{
    map(parse_der_sequence_of_v(f), BerObject::from_seq)
}
...
/// ```rust
/// # use der_parser::ber::BerObject;
/// # use der_parser::der::{parse_der_integer, parse_der_sequence_of_v};
/// # use der_parser::error::BerResult;
/// #
/// /// Read a SEQUENCE OF INTEGER
...
/// ```rust
/// # use der_parser::ber::BerObject;
/// # use der_parser::der::{parse_der_integer, parse_der_sequence_defined};
/// # use der_parser::error::BerResult;
...
/// ```rust
/// # use der_parser::ber::BerObject;
/// # use der_parser::der::{parse_der_integer, parse_der_set_of};
/// # use der_parser::error::BerResult;
/// #
...
where
    F: Fn(&'a [u8]) -> BerResult,
{
    map(parse_der_set_of_v(f), BerObject::from_set)
}
...
/// ```rust
/// # use der_parser::ber::BerObject;
/// # use der_parser::der::{parse_der_integer, parse_der_set_of_v};
/// # use der_parser::error::BerResult;
/// #
/// /// Read a SET OF INTEGER
/// fn parser(i:&[u8]) -> BerResult<Vec<BerObject>> {
...
/// ```rust
/// # use der_parser::ber::BerObject;
/// # use der_parser::der::{parse_der_integer, parse_der_set_defined};
/// # use der_parser::error::BerResult;
/// use nom::combinator::complete;
/// use nom::multi::many1;
///
