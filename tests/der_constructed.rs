...
#[test_case(&hex!("a2 80 02 03 01 00 01 00 00"), Err(BerError::IndefiniteLengthUnexpected) ; "indefinite tag ok")]
...
#[test_case(&hex!("30 80 02 03 01 00 01 00 00"), Err(BerError::IndefiniteLengthUnexpected) ; "indefinite seq ok")]
...
#[test_case(&hex!("30 80 02 03 01 00 01 00 00"), Err(Err::Error(BerError::IndefiniteLengthUnexpected)) ; "indefinite seq ok")]
...
#[test_case(&hex!("31 80 02 03 01 00 01 00 00"), Err(BerError::IndefiniteLengthUnexpected) ; "indefinite set ok")]
...
#[test_case(&hex!("31 80 02 03 01 00 01 00 00"), Err(Err::Error(BerError::IndefiniteLengthUnexpected)) ; "indefinite set ok")]
