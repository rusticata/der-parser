...
#[test_case(&hex!("31 0a 02 03 01 00 01 02 03 01 00 00"), Err(BerError::unexpected_tag(Tag::Sequence, Tag::Set)) ; "invalid tag")]
...
#[test_case(&hex!("30 0a 02 03 01 00 01 02 03 01 00 00"), Err(BerError::unexpected_tag(Tag::Set, Tag::Sequence)) ; "invalid tag")]
